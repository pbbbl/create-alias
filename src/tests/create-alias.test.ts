...
var cycle = 0;
const runTest = (options: TestOptions = tests[0], index: number = 0, alias: Alias = alias1, expectedFile: { [key: string]: any }, shouldDeleteFile: boolean = false) => {
